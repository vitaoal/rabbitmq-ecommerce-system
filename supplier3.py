...
def main():
    ...
    private = load_private_key(r'keys\supplier_3\private_key.pem')

    # Nome único da fila para 'order.white'
    queue_name = 'order_queue_white'
    channel.queue_declare(queue=queue_name, exclusive=True)
    channel.queue_bind(exchange='order_type', queue=queue_name, routing_key='order.white')

    # Consumir mensagens específicas do tópico 'order.white'
    ...
    print("Aguardando mensagens do tópico 'order.white'...")
